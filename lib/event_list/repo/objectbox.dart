...
import 'package:sqliteapp/event_list/models/owner.dart';
import 'package:sqliteapp/event_list/models/task.dart';
...
class ObjectBox {
  ...
  List<Event> getEvents() {
    final builder = eventBox.query().order(Event_.id, flags: Order.descending).build();
    return builder.find();
  }
